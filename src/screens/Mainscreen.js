    ...
    <View style={styles.background}>
      <View style={styles.container}>
        ...
        <View>
          ...
          <Text style={styles.explain}>오늘은 평안하신가요?</Text>
        </View>
        <View>
          <View style={styles.box}>
            <View style={{ marginLeft: 60, marginTop: 40 }}>
              ...
              />
              <Text style={{ marginLeft: 5, marginTop: 8, color: "#AEAEAE" }}>
                취침
              </Text>
            </View>
            <View
              style={{ position: "absolute", marginLeft: 230, marginTop: 40 }}
            >
              <Image source={require("../images/phone.png")} />
              <Text style={{ marginLeft: 5, marginTop: 8, color: "#AEAEAE" }}>
                상담
            ...
            <View style={{ marginLeft: 60, marginTop: 95 }}>
              <Image source={require("../images/camera.png")} />
              <Text style={{ marginLeft: 2, marginTop: 8, color: "#AEAEAE" }}>
                카메라
              </Text>
            </View>
            <View
              style={{ position: "absolute", marginLeft: 230, marginTop: 185 }}
            >
              <Image source={require("../images/volume.png")} />
              <Text style={{ marginLeft: 5, marginTop: 8, color: "#AEAEAE" }}>
                음성
              </Text>
>>>>>>> f51dd96c96537d0cecaec501351cd61572fe48dd:src/screens/mainscreen.js
            </View>
            <View style={{ marginLeft: 60, marginTop: 100 }}>
              <Image source={require("../images/setting.png")} />
              <Text style={{ marginLeft: 5, marginTop: 8, color: "#AEAEAE" }}>
            ...
            <View
              style={{ position: "absolute", marginLeft: 230, marginTop: 340 }}
            >
              <Image source={require("../images/bell.png")} />
              <Text style={{ marginLeft: 5, marginTop: 8, color: "#AEAEAE" }}>
                알림
